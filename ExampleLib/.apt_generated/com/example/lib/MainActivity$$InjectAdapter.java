...
public final class MainActivity$$InjectAdapter extends Binding<MainActivity>
  ...
  public MainActivity$$InjectAdapter() {
    super("com.example.lib.MainActivity", "members/com.example.lib.MainActivity", NOT_SINGLETON, MainActivity.class);
  }
  ...
  public void attach(Linker linker) {
    mAppConfig = (Binding<AppConfig>) linker.requestBinding("com.example.lib.AppConfig", MainActivity.class, getClass().getClassLoader());
    supertype = (Binding<BaseActivity>) linker.requestBinding("members/com.example.lib.BaseActivity", MainActivity.class, getClass().getClassLoader(), false, true);
  }
  ...
  public void getDependencies(Set<Binding<?>> getBindings, Set<Binding<?>> injectMembersBindings) {
    injectMembersBindings.add(mAppConfig);
  ...
  public void injectMembers(MainActivity object) {
    object.mAppConfig = mAppConfig.get();
